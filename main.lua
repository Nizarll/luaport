...
function get_path(header)
  for key, route in pairs(routes) do
    if utils.ends_with(header, 'css') and header == route.css.header then return route.css.path
    elseif utils.ends_with(header, 'js') and header == route.js.header then return route.js.path
